...
class CharStack {
	...
	public String getStackAsString() {
		StringBuilder stackString = new StringBuilder("Stack S = [");
		for (int i = 0; i < iSize; i++) {
			char element = aCharStack[i];
			stackString.append("[" + element + "]");
			if (i < iSize - 1) {
				stackString.append(",");
			}
		}
	 ...
	 */
	public static char getAt(int piPosition) throws CharStackInvalidAceessException {
	...
	public String getAccessCounter() {
		...
		return String.valueOf(this.AccessCounter);
	}
}
